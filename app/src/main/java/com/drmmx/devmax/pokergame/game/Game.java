...
class Game {
    static ArrayList<Player> playerSetup(String[] playerNameArray, int playerStartingMoney) {
    ...
    static String callButton(Player currentPlayer, Board currentGame) {
        String output;
    ...
    static void turnAction(Player currentPlayer, ArrayList<Player> players, Board currentGame, String decision, int betAmount) {
        switch (decision) {
            case "Fold":  //set the users state to fold and end turn
                currentPlayer.setState("folded");
                break;
            case "Call":  //bet the amount required and end turn
                ...
                break;
            case "Check":  //set state to have bet and move to next player
                currentPlayer.setState("active|b");
                break;
            case "Bet":  //request the amount the user wants to bet and then end turn
    ...
    static void roundSetup(Board currentGame, ArrayList<Player> players, int blind, int smallBlind, CardSet deck){
    ...
    static ArrayList<String> iterateBetRound(Board currentGame, ArrayList<Player> players, int round, CardSet deck) {
    ...
    static void resetRound(Board currentGame, ArrayList<Player> players){
        currentGame.clearPot();
